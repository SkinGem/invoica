  ...
  return (
    <>
      ...
      <main className="max-w-3xl mx-auto px-6 py-24">
        <h1 className="text-4xl font-bold text-invoica-blue dark:text-white mb-2">Privacy Policy</h1>
        ...
        <div className="prose prose-slate max-w-none space-y-8 text-invoica-gray-600 dark:text-gray-300 leading-relaxed">
          <section>
            <h2 className="text-xl font-semibold text-invoica-blue dark:text-gray-100 mt-8 mb-3">1. Introduction</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-semibold text-invoica-blue dark:text-gray-100 mt-8 mb-3">2. Information We Collect</h2>
            <h3 className="text-lg font-medium text-invoica-blue dark:text-gray-200 mt-4 mb-2">Account Information</h3>
            ...
            <h3 className="text-lg font-medium text-invoica-blue dark:text-gray-200 mt-4 mb-2">Invoice Data</h3>
            ...
            <h3 className="text-lg font-medium text-invoica-blue dark:text-gray-200 mt-4 mb-2">Usage Data</h3>
            <p>We collect information about how you use the Service, including API call logs, feature usage, and performance metrics.</p>

            <h3 className="text-lg font-medium text-invoica-blue dark:text-gray-200 mt-4 mb-2">Technical Data</h3>
          ...
          <section>
            <h2 className="text-xl font-semibold text-invoica-blue dark:text-gray-100 mt-8 mb-3">3. How We Use Your Information</h2>
          ...
          <section>
            <h2 className="text-xl font-semibold text-invoica-blue dark:text-gray-100 mt-8 mb-3">4. Data Sharing</h2>
          ...
          <section>
            <h2 className="text-xl font-semibold text-invoica-blue dark:text-gray-100 mt-8 mb-3">5. Data Retention</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-semibold text-invoica-blue dark:text-gray-100 mt-8 mb-3">6. Data Security</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-semibold text-invoica-blue dark:text-gray-100 mt-8 mb-3">7. Your Rights (GDPR / CCPA)</h2>
          ...
          <section>
            <h2 className="text-xl font-semibold text-invoica-blue dark:text-gray-100 mt-8 mb-3">8. Cookies</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-semibold text-invoica-blue dark:text-gray-100 mt-8 mb-3">9. International Data Transfers</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-semibold text-invoica-blue dark:text-gray-100 mt-8 mb-3">10. Children&apos;s Privacy</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-semibold text-invoica-blue dark:text-gray-100 mt-8 mb-3">11. Changes to This Policy</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-semibold text-invoica-blue dark:text-gray-100 mt-8 mb-3">12. Contact Us</h2>
            <p>
