  ...
  return (
    <>
      ...
      <main className="max-w-3xl mx-auto px-6 py-24">
        <h1 className="text-4xl font-bold text-invoica-blue dark:text-white mb-2">Terms of Service</h1>
        ...
        <div className="prose prose-slate max-w-none space-y-8 text-invoica-gray-600 dark:text-gray-300 leading-relaxed">
          <section>
            <h2 className="text-xl font-semibold text-invoica-blue dark:text-gray-100 mt-8 mb-3">1. Acceptance of Terms</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-semibold text-invoica-blue dark:text-gray-100 mt-8 mb-3">2. Description of Service</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-semibold text-invoica-blue dark:text-gray-100 mt-8 mb-3">3. Account Registration</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-semibold text-invoica-blue dark:text-gray-100 mt-8 mb-3">4. Acceptable Use</h2>
          ...
          <section>
            <h2 className="text-xl font-semibold text-invoica-blue dark:text-gray-100 mt-8 mb-3">5. Pricing and Payment</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-semibold text-invoica-blue dark:text-gray-100 mt-8 mb-3">6. API Usage and Rate Limits</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-semibold text-invoica-blue dark:text-gray-100 mt-8 mb-3">7. Data and Privacy</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-semibold text-invoica-blue dark:text-gray-100 mt-8 mb-3">8. Tax Compliance Disclaimer</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-semibold text-invoica-blue dark:text-gray-100 mt-8 mb-3">9. Intellectual Property</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-semibold text-invoica-blue dark:text-gray-100 mt-8 mb-3">10. Service Availability</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-semibold text-invoica-blue dark:text-gray-100 mt-8 mb-3">11. Limitation of Liability</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-semibold text-invoica-blue dark:text-gray-100 mt-8 mb-3">12. Termination</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-semibold text-invoica-blue dark:text-gray-100 mt-8 mb-3">13. Changes to Terms</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-semibold text-invoica-blue dark:text-gray-100 mt-8 mb-3">14. Contact</h2>
            <p>
