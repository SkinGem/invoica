    ...
    <section id="products" className="py-24 bg-white dark:bg-gray-950">
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center mb-16">
          ...
          <h2 className="text-3xl md:text-5xl font-bold text-invoica-blue dark:text-white mb-4 tracking-tight">
            Built on Invoica
          </h2>
          <p className="text-base md:text-lg text-invoica-gray-500 dark:text-gray-400 max-w-2xl mx-auto">
        ...
        <a
          href="/clinpay"
          className="group block relative rounded-3xl border border-invoica-gray-200 dark:border-gray-700 hover:border-invoica-purple/40 bg-gradient-to-br from-white dark:from-gray-900 via-invoica-purple/[0.02] dark:via-invoica-purple/[0.04] to-invoica-purple/[0.06] dark:to-invoica-purple/[0.08] overflow-hidden transition-all duration-300 hover:shadow-2xl hover:shadow-invoica-purple/10 hover:-translate-y-1"
        >
          ...
          <div className="relative grid md:grid-cols-5 gap-8 p-8 md:p-12">
            ...
            <div className="md:col-span-3">
              ...
              <h3 className="text-4xl md:text-5xl font-bold text-invoica-blue dark:text-white mb-4 tracking-tight">
                ClinPay
              ...
              <p className="text-lg text-invoica-gray-600 dark:text-gray-300 mb-6 leading-relaxed">
              ...
              <div className="grid grid-cols-2 gap-3 mb-8">
                {[
                  ...
                  <div key={i} className="flex items-start gap-2">
                    ...
                    <span className="text-sm text-invoica-gray-500 dark:text-gray-400 leading-snug">{line}</span>
                  </div>
                ))}
              </div>
            ...
            <div className="md:col-span-2 flex flex-col justify-center">
              <div className="rounded-2xl border border-invoica-gray-200 dark:border-gray-700 bg-white/70 dark:bg-gray-800/70 backdrop-blur-sm p-6">
                <div className="text-xs font-semibold text-invoica-gray-500 dark:text-gray-400 uppercase tracking-wider mb-4">
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex items-center gap-3 p-3 rounded-xl bg-invoica-gray-50 dark:bg-gray-800 border border-invoica-gray-200 dark:border-gray-700">
                    <div className="w-8 h-8 rounded-lg bg-invoica-blue flex items-center justify-center text-white font-bold text-xs">A</div>
                    <div>
                      <div className="text-sm font-semibold text-invoica-blue dark:text-white">AsterPay</div>
                      <div className="text-xs text-invoica-gray-500 dark:text-gray-400">MiCA-aligned EU rail</div>
                    </div>
                  </div>
                </div>
                <div className="mt-4 pt-4 border-t border-invoica-gray-200/60 dark:border-gray-700/60 text-xs text-invoica-gray-500 dark:text-gray-400">
