...
const enterpriseFeatures = [
  ...
  },
  {
    ...
    description: 'Automatic VAT and sales tax across 12 countries: EU, UK, France, Germany, Canada, Japan, Israel, Australia, Singapore, UAE, Brazil, and Mexico. Reverse charge, VIES validation, and audit-ready reports included.',
  },
  {
    icon: (
      <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-start">
          ...
          <div className="lg:sticky lg:top-32">
            ...
            <div className="grid grid-cols-2 gap-6 mb-10">
              {[
                { value: '12', label: 'Countries — auto tax & VAT' },
                { value: '4', label: 'Chains — Base · Polygon · Arbitrum · SOL' },
