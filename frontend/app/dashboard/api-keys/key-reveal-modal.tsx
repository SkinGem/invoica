        ...
        <div className="flex items-start gap-3 mb-5">
          ...
          <div>
            ...
            <p className="text-sm text-gray-500 dark:text-gray-400 mt-0.5">
              Key <span className="font-medium text-gray-700 dark:text-gray-200">&ldquo;{keyName}&rdquo;</span> was created successfully
            </p>
          </div>
        </div>

        {/* Warning banner */}
        <div className="flex items-start gap-2.5 bg-amber-50 dark:bg-amber-950/20 border border-amber-200 dark:border-amber-800/30 rounded-xl px-4 py-3 mb-4">
