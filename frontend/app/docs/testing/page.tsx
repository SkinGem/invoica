export default function TestingPage() {
  return (
    <div className="max-w-4xl mx-auto py-8 px-4">
      <h1 className="text-3xl font-bold mb-6 dark:text-white">Testing Guide</h1>
      <p className="text-gray-600 dark:text-gray-400 mb-8">Best practices for testing your Invoica integration.</p>

      <section className="mb-8">
        <h2 className="text-2xl font-semibold mb-4 dark:text-white">Sandbox Environment</h2>
        <p className="text-gray-600 dark:text-gray-400 mb-3">Use the sandbox base URL for testing without affecting production data.</p>
  ...
  baseUrl: 'https://sandbox.invoica.ai/v1'
      ...
      <section className="mb-8">
        <h2 className="text-2xl font-semibold mb-4 dark:text-white">Mocking the Client</h2>
        <p className="text-gray-600 dark:text-gray-400 mb-3">Use Jest to mock SDK methods in your unit tests.</p>
...
(CountableClient as jest.Mock).mockImplementation(() => ({
  invoices: { create: mockCreate }
      ...
      <section className="mb-8">
        <h2 className="text-2xl font-semibold mb-4 dark:text-white">Webhook Testing</h2>
        <p className="text-gray-600 dark:text-gray-400 mb-3">Verify webhook signatures in your test suite.</p>
...
expect(event.type).toBe('invoice.paid');`}</pre>
      ...
      <section>
        <h2 className="text-2xl font-semibold mb-4 dark:text-white">Test Checklist</h2>
