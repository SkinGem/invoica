...
export default function WebhookVerificationPage() {
  return (
    <div className="max-w-4xl mx-auto py-12 px-6">
      <h1 className="text-3xl font-bold mb-6 dark:text-white">Webhook Verification</h1>
      ...
      <section className="mb-8">
        <h2 className="text-2xl font-semibold mb-4 dark:text-white">Code Example</h2>
...
app.post('/webhooks', express.raw({ type: 'application/json' }), (req: Request, res: Response) => {
  ...
  return res.status(200).json({ received: true });
      ...
      <section>
        <h2 className="text-2xl font-semibold mb-4 dark:text-white">Security Best Practices</h2>
